...
The technique is as far as I understand the one suited to the Guile 1 series - for the Guile 2/3 I have seen that anoteher technique exists, based on the `(ice-9 sandbox)` module; see  this [message](https://www.mail-archive.com/guile-user@gnu.org/msg10788.html) in the Guile maling list
